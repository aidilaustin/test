...
sleep 1
wget -O /usr/bin/add-ws "https://raw.githubusercontent.com/cardinalproject/test/main/xray/add-ws.sh" && chmod +x /usr/bin/add-ws
wget -O /usr/bin/add-vless "https://raw.githubusercontent.comcardinalproject/test/cardinalproject/test/main/xray/add-vless.sh" && chmod +x /usr/bin/add-vless
wget -O /usr/bin/add-tr "https://raw.githubusercontent.com/cardinalproject/test/main/xray/add-tr.sh" && chmod +x /usr/bin/add-tr
wget -O /usr/bin/del-user "https://raw.githubusercontent.com/cardinalproject/test/main/xray/del-ws.sh" && chmod +x /usr/bin/del-user
wget -O /usr/bin/cek-user "https://raw.githubusercontent.com/cardinalproject/test/main/xray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
wget -O /usr/bin/renew-user "https://raw.githubusercontent.com/cardinalproject/test/main/xray/renew-ws.sh" && chmod +x /usr/bin/renew-user
wget -O /usr/bin/crtv2ray "https://raw.githubusercontent.com/cardinalproject/test/main/xray/crt.sh" && chmod +x /usr/bin/crtv2ray
wget -O /usr/bin/add-ssws "https://raw.githubusercontent.com/cardinalproject/test/main/xray/add-ssws.sh" && chmod +x /usr/bin/add-ssws
sleep 1
